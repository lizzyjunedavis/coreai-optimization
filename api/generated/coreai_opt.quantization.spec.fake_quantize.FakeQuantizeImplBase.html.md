...
### *class* coreai_opt.quantization.spec.fake_quantize.FakeQuantizeImplBase(dtype, qformulation, granularity, target_dtype, quant_min, quant_max, qparams_calculator, quantization_target, n_bits=None, \*\*kwargs)
...
#### \_\_init_\_(dtype, qformulation, granularity, target_dtype, quant_min, quant_max, qparams_calculator, quantization_target, n_bits=None, \*\*kwargs)
